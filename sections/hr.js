...
const hrData = {
  ...
  // --------------------------------------------------------------------------
  pitch: {
    short: `Bonjour, je suis Maxime Launoy, ingénieur diplômé de l'INSA en 2024. Depuis un an, je travaille en sécurité informatique chez Harvest, une fintech, où je gère la sécurité d'un parc de plus de mille machines — durcissement, conformité ISO 27001, gestion des vulnérabilités — avec une exposition aux outils SIEM et EDR dans le cadre de mes reportings sécurité. Je souhaite aujourd'hui rejoindre le SOC de Sopra Steria pour passer à l'opérationnel pur : détection, analyse d'alertes, investigation, et monter en compétences sur Splunk et le threat hunting.`,
