...
const hrData = {
  ...
  // --------------------------------------------------------------------------
  pitch: {
    short: `Bonjour, je suis Maxime Launoy, ingénieur diplômé de l'INSA en 2024. Depuis un an, je travaille en cybersécurité chez Harvest, une fintech, où je gère le SIEM Rapid7 InsightIDR, l'EDR Cybereason et la conformité ISO 27001 sur un parc de plus de mille machines. Je souhaite aujourd'hui rejoindre le SOC de Sopra Steria pour évoluer vers des missions plus variées, approfondir mes compétences en détection et en threat hunting, et contribuer à la protection de clients grands comptes.`,

    medium: `Bonjour, je suis Maxime Launoy, ingénieur diplômé de l'INSA promotion 2024. Depuis un an, j'occupe un poste en cybersécurité chez Harvest, une fintech spécialisée dans la gestion de patrimoine. Au quotidien, j'opère le SIEM Rapid7 InsightIDR pour la détection d'incidents, je gère l'EDR Cybereason pour la réponse sur les endpoints, et j'administre Tanium pour le management de plus de mille postes. J'ai également piloté le déploiement en urgence de BitLocker sur l'ensemble du parc suite à une crise de sécurité, et je contribue activement à la conformité ISO 27001 avec des reportings réguliers au COMEX. Avant cela, j'ai fait un stage de quatre mois en infrastructure chez Harvest, où j'ai automatisé des tâches avec Ansible et mis en place du monitoring PRTG. Ce qui me motive chez Sopra Steria, c'est la diversité des environnements clients, la montée en compétences sur Splunk et le framework MITRE ATT&CK, et l'opportunité de travailler dans un SOC structuré avec des experts reconnus.`,

    long: `Bonjour, je suis Maxime Launoy, ingénieur diplômé de l'INSA en 2024. Je suis trilingue français, russe et anglais, avec un niveau C1 certifié au TOEIC, et j'ai aussi un bon niveau en espagnol. Mon parcours en cybersécurité a véritablement commencé chez Harvest, une fintech qui gère des solutions de gestion de patrimoine pour les banques et CGP. J'y ai d'abord effectué un stage de quatre mois en infrastructure et exploitation, pendant lequel j'ai automatisé des déploiements avec Ansible et mis en place une supervision PRTG. Cette expérience m'a donné une compréhension solide des infrastructures, ce qui est essentiel quand on fait de la cybersécurité : il faut comprendre ce qu'on protège. Ensuite, j'ai été embauché sur un poste dédié cybersécurité. Pendant un an, j'ai opéré le SIEM Rapid7 InsightIDR au quotidien — création de règles de détection, analyse d'alertes, investigation d'incidents. Je gère aussi l'EDR Cybereason pour la protection et la réponse sur les endpoints, et Tanium pour le management de plus de mille machines. Un moment fort de mon expérience a été le déploiement en urgence de BitLocker sur tout le parc après une alerte critique : j'ai dû coordonner les équipes, gérer la pression du COMEX, et livrer en un temps record. Je suis également impliqué dans la conformité ISO 27001, la gestion des vulnérabilités sur plus de mille VM, et je produis des reportings cybersécurité pour la direction. En parallèle, je me forme en continu : je m'entraîne sur Splunk, j'étudie le framework MITRE ATT&CK, et je développe un projet personnel en Next.js et React qui montre ma capacité à apprendre vite. Ce qui m'attire chez Sopra Steria, c'est la possibilité de rejoindre un SOC mature, de travailler sur des environnements clients variés, de monter en compétences sur Splunk qui est le standard du marché, et de m'inscrire dans une trajectoire de carrière ambitieuse en cybersécurité. Je sais aussi que d'anciens camarades de l'INSA y travaillent et m'en parlent très positivement, ce qui renforce ma motivation.`
  },
  ...
  questions: [
    // ---- 1. Présentation ----
    {
      ...
      q: "Présentez-vous",
      answer: `Je suis Maxime Launoy, ingénieur INSA promotion 2024, actuellement en poste en cybersécurité chez Harvest, une fintech. Au quotidien, j'opère le SIEM Rapid7 InsightIDR, l'EDR Cybereason et Tanium sur un parc de plus de mille machines. J'ai piloté des projets critiques comme le déploiement BitLocker en urgence et je contribue à la conformité ISO 27001. Mon parcours combine une base solide en infrastructure — grâce à mon stage où j'ai fait de l'automatisation Ansible et du monitoring PRTG — et une expertise opérationnelle en sécurité. Je suis trilingue français-russe-anglais et j'ai un esprit très orienté amélioration continue. Aujourd'hui, je souhaite rejoindre le SOC de Sopra Steria pour évoluer vers des environnements plus variés, approfondir mes compétences en Splunk et en threat hunting, et construire une carrière ambitieuse en cybersécurité.`,
    ...
    // ---- 5. Vos faiblesses ----
    {
      ...
      answer: `J'ai tendance à vouloir trop approfondir les sujets, ce qui peut parfois me faire passer plus de temps que nécessaire sur une investigation. Chez Harvest, quand j'analyse une alerte, je veux comprendre toute la chaîne d'attaque plutôt que de juste traiter le symptôme. C'est une qualité dans un rôle d'analyste SOC, mais j'apprends à mieux prioriser et à savoir quand une investigation est « suffisamment » complète pour passer à autre chose. J'ai aussi identifié que mon expérience directe avec Splunk est encore en construction — j'utilise Rapid7 InsightIDR au quotidien — mais c'est précisément pour ça que je me forme activement et que ce poste m'attire : je veux maîtriser l'outil de référence du marché. Enfin, étant donné que je n'ai qu'un an d'expérience en cyber, je suis conscient qu'il me reste beaucoup à apprendre en matière de threat hunting avancé et d'analyse de malware, mais j'ai la base solide et la motivation pour progresser rapidement.`,
    ...
    // ---- 10. Pourquoi vous recruter ----
    {
      ...
      answer: `Vous devriez me recruter pour trois raisons. Premièrement, j'apporte une expérience opérationnelle réelle en cybersécurité — pas juste théorique. Depuis un an chez Harvest, je gère un SIEM, un EDR, du management endpoint et de la conformité ISO 27001 au quotidien. Je sais ce que c'est de traiter des alertes, d'investiguer un incident, de reporter à la direction. Deuxièmement, j'ai un profil qui combine infrastructure et sécurité. Mon stage en exploitation m'a donné une compréhension des systèmes que je protège — réseaux, serveurs, Active Directory — ce qui me rend plus efficace en tant qu'analyste SOC. Troisièmement, j'ai un potentiel de croissance rapide. En un an, je suis passé de stagiaire à référent cyber qui reporte au COMEX. Je me forme déjà à Splunk en autonomie. Je suis trilingue, ce qui est un atout pour un SOC qui traite des menaces internationales. Et surtout, je suis motivé et passionné — ce n'est pas juste un job pour moi, c'est ma vocation. Je suis prêt à m'investir pleinement et à apporter de la valeur dès le premier jour.`,
    ...
    // ---- 11. Prétentions salariales ----
    {
      ...
      answer: `Sur la base de mon profil — ingénieur INSA avec un an d'expérience opérationnelle en cybersécurité, trilingue, et compte tenu du marché actuel pour un analyste SOC en région — je me positionne sur une fourchette de 38 000 à 42 000 euros brut annuel. C'est une fourchette que j'ai établie en tenant compte de la grille Sopra Steria pour les profils juniors-confirmés et du fait que je suis immédiatement opérationnel sur les outils SIEM et EDR. Cela dit, la rémunération n'est pas mon critère principal : ce qui compte le plus pour moi, c'est la qualité des missions, les possibilités de formation et de certification, et la trajectoire d'évolution. Je suis ouvert à la discussion sur le package global — fixe, variable, avantages.`,
    ...
    // ---- 18. Expérience avec les outils SIEM (question technique légère) ----
    {
      ...
      answer: `C'est une très bonne question et j'y ai déjà réfléchi. D'abord, les concepts fondamentaux sont les mêmes entre tous les SIEM : collecte de logs, corrélation, création de règles de détection, investigation d'alertes, gestion des incidents. Ce qui change, c'est la syntaxe de requête et l'interface. J'utilise InsightIDR quotidiennement depuis un an, donc j'ai une solide compréhension de la logique SIEM. Pour Splunk spécifiquement, j'ai déjà commencé à me former : j'ai monté un environnement d'entraînement personnel où je pratique le SPL — le langage de requête Splunk — avec des jeux de données réalistes. Je travaille sur les dashboards, les alertes, les lookups, et je me familiarise avec l'écosystème Splunk Enterprise Security. En parallèle, j'étudie la documentation officielle Splunk et les ressources BOTSv. Je suis confiant que ma base SIEM solide combinée à cet apprentissage proactif me permettra d'être opérationnel rapidement sur Splunk chez Sopra Steria.`,
    ...
    // ---- 20. Gestion de la routine ----
    {
      ...
      answer: `Je comprends que le traitement d'alertes peut sembler répétitif vu de l'extérieur, mais dans mon expérience, chaque alerte est potentiellement unique. Chez Harvest, je traite des dizaines d'alertes par semaine sur InsightIDR, et j'ai appris à rester vigilant même sur les alertes qui semblent banales — c'est souvent dans le bruit que se cache une vraie menace. Cela dit, quand une tâche est véritablement répétitive, mon réflexe est de l'automatiser ou de l'optimiser. Par exemple, j'ai créé des templates d'investigation et des checklists pour les types d'alertes les plus fréquents, ce qui me permet de gagner du temps tout en maintenant la rigueur. J'utilise aussi les périodes plus calmes pour améliorer les règles de détection, réduire les faux positifs, documenter les procédures, ou me former. Dans un SOC, on n'est jamais vraiment dans la routine si on cherche constamment à s'améliorer et à améliorer les processus.`,
